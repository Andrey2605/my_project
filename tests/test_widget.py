...
def test_mask_account_card(number: str, mask_account_and_card: str) -> Any:
...
def test_mask_account_card_errors(incorrect_data: str) -> Any:
...
def test_get_date_not_standart(incorrect_data: str) -> Any:
...
def test_get_not_date(incorrect_data: str) -> Any:
