...
def test_filter_by_state(filter_state: str) -> Any:
...
def test_filter_by_state_different_meanings() -> Any:
...
def test_sort_by_date(date: list, sorted_list_descending: list) -> Any:
    """Тестирование сортировки списка словарей по датам в порядке убывания"""
    assert sort_by_date(date) == sorted_list_descending


def test_sort_by_identical_date(sorted_list_identical: list) -> Any:
...
def test_sort_by_date_not_standart(sorted_list_not_standard: list) -> Any:
