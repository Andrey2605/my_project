...
def test_filter_by_state_different_meanings():
...
def test_sort_by_identical_date(sorted_list_identical):
...
def test_sort_by_date_not_standart(sorted_list_not_standard):
